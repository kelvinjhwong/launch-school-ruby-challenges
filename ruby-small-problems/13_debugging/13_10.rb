...
We're performing integer division, rather than
float division. In order to perform float division,
we need to first call the method #to_f on both variables,
or at least on `number_of_documents`
